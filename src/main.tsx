...
import App from "./App";
import "./index.css";
import Vanta from "./libs/animateBg";
...
const route = {
  ...
  Page404: {
    path: "/404",
    component: <Screen.Page404 />,
  },
  Article: {
    path: "/article",
    component: <Screen.Article />,
  },
};
